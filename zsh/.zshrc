...
zfetch robbyrussell/oh-my-zsh lib/git.zsh
zfetch robbyrussell/oh-my-zsh plugins/git/git.plugin.zsh
zfetch robbyrussell/oh-my-zsh plugins/ssh-agent
zfetch robbyrussell/oh-my-zsh plugins/pyenv
zfetch b4b4r07/cli-finder
